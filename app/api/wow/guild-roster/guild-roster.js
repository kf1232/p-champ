/**
 * Battle.net WoW Game Data API — Guild Roster.
 *
 * GET /data/wow/guild/{realmSlug}/{nameSlug}/roster
 * Uses `namespace=profile-{region}` (matches Blizzard roster `href` on guild summary).
 ...
 */
export async function getGuildRoster(input) {
  ...
  const url = `https://${host}/data/wow/guild/${realmEnc}/${guildEnc}/roster?${qs}`;
