/**
 * Battle.net WoW Profile API — Character Mythic Keystone Profile Index.
 *
 ...
 */
export async function getCharacterMythicKeystoneProfile(input) {
  ...
  const url = `https://${host}/profile/wow/character/${realmEnc}/${nameEnc}/mythic-keystone-profile?${qs}`;
